...
function Presentation({logement}){
    ...
    <section className="presentation">
        <LogementHeader title={logement.title} name={logement.host.name} 
        picture={logement.host.picture} location={logement.location} 
        tags={logement.tags} rating={logement.rating}
        />
