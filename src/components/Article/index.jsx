...
function toggleVisibility(el) {
  ...
  const elt = document.getElementById(
    "up_" + el.currentTarget.dataset.prefixindex
  )
  elt.classList.toggle("invisible")
  const eltToggle = document.getElementById(
    "down_" + el.currentTarget.dataset.prefixindex
  )
  eltToggle.classList.toggle("invisible")
  const eltText = document.getElementById(
    "text_" + el.currentTarget.dataset.prefixindex
  )
